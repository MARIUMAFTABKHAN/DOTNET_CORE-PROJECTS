<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgencyGroupform.aspx.cs" Inherits="AMR.AgencyGroupform" %>
                ...
                <br />
                 ...
                 <div class="form-group">
                    ...
                    <div class="div-md-12" style="margin-top: 50px;">
                        <asp:GridView ID="gv" PageSize="25" runat="server" CssClass="EU_DataTable" DataKeyNames="RecID" AutoGenerateColumns="false"
                            AllowPaging="True" OnPageIndexChanging="gv_PageIndexChanging">
                            <PagerStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                            <Columns>
                                <%--<asp:BoundField DataField="ID" HeaderText="ID"><HeaderStyle Width="10%" /></asp:BoundField>--%>
                                <asp:BoundField DataField="Group_Caption" HeaderText="Caption"><HeaderStyle Width="10%" /></asp:BoundField>
                                ...
                                <%--<asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <center>
                                            ...
                                            CommandName="Delete" CommandArgument='<%# Eval("RecID") %>' OnClick="DeleteButton_Click" ValidationGroup="a"/>
                                        </center>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DesignationManagement.aspx.cs" Inherits="AMR.DesignationManagement " %>
                    ...
                    <div class="form-group">
                        <div class="div-md-12">
                            ...
                            <div class="col-md-3">
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="txtDesignation" ForeColor="Red" Display="Dynamic"
                    ...
                    <div class="form-group">
                        ...
                        <div style="margin-top: 50px; text-align:center; margin-left: 230px;">
                            <asp:GridView ID="gv" PageSize="20"  runat="server" CssClass="EU_DataTable" DataKeyNames="Id" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Desgn_Name" HeaderText="DESIGNATION">

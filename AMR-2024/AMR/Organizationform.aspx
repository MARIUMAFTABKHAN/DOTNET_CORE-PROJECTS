<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Organizationform.aspx.cs" Inherits="AMR.Organizationform" %>
                ...
                <div class="form-group">
                   ...
                   <div class="div-md-12" style="margin-top: 50px; ">
                       <asp:GridView ID="gv" PageSize="25" runat="server" CssClass="EU_DataTable" DataKeyNames="ID" AutoGenerateColumns="false"
                           ...
                           <Columns>
                               <asp:BoundField DataField="Title" HeaderText="Title"><HeaderStyle Width="40%" /></asp:BoundField>
                               <asp:BoundField DataField="User_Name" HeaderText="User Id"><HeaderStyle Width="40%" /></asp:BoundField>

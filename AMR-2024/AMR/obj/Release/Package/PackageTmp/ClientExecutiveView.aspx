<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClientExecutiveView.aspx.cs" Inherits="AMR.ClientExecutiveView" %>
                        ...
                        <div class="div-md-12" style="margin-top: 50px; width: 100%;">
                            <asp:GridView ID="gv" PageSize="100" runat="server" CssClass="EU_DataTable" DataKeyNames="Id" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Exec1_UserName" HeaderText="Executive1 User">
                                        <HeaderStyle Width="10%" HorizontalAlign="Center"/>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="Exec2_UserName" HeaderText="Executive2 User">
                                        <HeaderStyle Width="10%" HorizontalAlign="Center"/>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:BoundField>
                                    ...
                                    <%--<asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="Edit">
                                        ...
                                        <asp:HyperLink ID="hypEdit" runat="server" 
                                            NavigateUrl = '<%# "ClientExecutiveform.aspx?Id=" + Convert.ToString(DataBinder.Eval(Container.DataItem,"Id")) + "&Mode=Edit" %>' 

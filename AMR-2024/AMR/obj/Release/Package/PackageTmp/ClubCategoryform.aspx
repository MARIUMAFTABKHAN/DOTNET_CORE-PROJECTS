<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClubCategoryform.aspx.cs" Inherits="AMR.ClubCategoryform" %>
                    ...
                    <div class="div-md-12" style="margin-top: 50px;">
                        <asp:GridView ID="gv" PageSize="25" runat="server" CssClass="EU_DataTable" DataKeyNames="ID" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ClubCategory_Title" HeaderText="Category Title"><HeaderStyle Width="15%" /></asp:BoundField>
                                <asp:BoundField DataField="MainCategory_Title" HeaderText="Main Category"><HeaderStyle Width="15%" /></asp:BoundField>
                                <asp:BoundField DataField="StatusDescription" HeaderText="Status"><HeaderStyle Width="15%" /></asp:BoundField>

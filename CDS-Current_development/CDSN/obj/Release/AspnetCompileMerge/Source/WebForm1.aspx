<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CDSN.WebForm1" %>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <strong>
                            <asp:Label ID="lblRecordHeader" runat="server" CssClass="lbl" Text="Channel Type Parameters" />
                        </strong>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <asp:GridView ID="gvRecords" runat="server" AllowPaging="false" AllowSorting="false" DataKeyNames="ID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="active" HeaderText="Active" SortExpression="CountryName">
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnDelete" ImageUrl="~/Content/Images/Trash-Cancel.ico" runat="server" ValidationGroup="a"
                                            OnClick="btnDelete_Click" OnClientClick='<%# "RemoveRecord(" +Eval("ID") + " );" %>' />
                                    </ItemTemplate>

...
{
    public partial class CashReceivedVoucher : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                var crvs = db.CRVStatus.ToList().OrderBy(x=> x.ID);
                ...
                if (btnSave.Text == "Save")
                {
                    ...
                    using (System.Transactions.TransactionScope scope = new System.Transactions.TransactionScope())
                    {
                        try
                        {
                            ...
                            crv.CRVAmount =Math.Round(Convert.ToDecimal(txtAmount.Text));
                            crv.GST     =  Math.Round( Convert.ToDecimal(txtGST.Text),0);
                            crv.WithHoldingTax = Math.Round(Convert.ToDecimal(txtWithhoding.Text), 0);
                            ...
                            crvd.CRVAmount = Math.Round(Convert.ToDecimal(crv.CRVAmount), 0);// + crv.GST + crv.WithHoldingTax);
                            crvd.ConsumedAmount = 0;
                            crvd.RemainingAmount = Math.Round(Convert.ToDecimal(crvd.CRVAmount),0);
                    ...
                    using (System.Transactions.TransactionScope scope = new System.Transactions.TransactionScope())
                    {
                        ...
                        if (crv.Status != 110000003 && crv.Status != 110000005)
                        {
                            try
                            {
                                ...
                                crv.PaymentNumber = txtChequeNo.Text;
                                crv.CRVDate = Helper.SetDateFormat(dtCRVDate.Text);
                                crv.CRVAmount = Math.Round(Convert.ToDecimal(txtAmount.Text), 0);
                                crv.GST = Math.Round(Convert.ToDecimal(txtGST.Text),0);
                                crv.WithHoldingTax  = Math.Round(Convert.ToDecimal(txtWithhoding.Text),0);
                                crv.ChequeDate = Helper.SetDateFormat(dtChequeDate.Text);
                                crv.Status = Convert.ToInt32(ddlCRVStatus.SelectedValue);
                        ...
                        else if (crv.Status == 110000005)
                        {
                            ...
                            crv.ChallanDate = dt;
                            crv.LastModifiedDate = DateTime.Now;
                            crv.LastModifiedBy = ((UserInfo)Session["UserObject"]).ID;// Convert.ToInt32(Session["UserID"]);
                            db.SaveChanges();
            ...
            if (CRVStatusID == 110000003)
            {
                ...
                if (ddlCRVStatus.SelectedItem.Text.Equals("Cleared"))
                {
                    ...
                    if (((chk == 4) || (chk == 5) || (chk == 6) || (chk == 7)) && crv == false)  // CRV 
                    {
                        ...
                        objLedgerBalance.ReceiptAmount =Math.Round( decimal.Parse(txtAmount.Text.Trim()),0);
                    ...
                    if (((chk == 1) || (chk == 3) || (chk == 5) || (chk == 7)) && tax == false)  // Tax
                    {
                        ...
                        objLedgerBalance.BillAmount = 0;
                        objLedgerBalance.ReceiptAmount =  Math.Round(decimal.Parse(txtWithhoding.Text.Trim()), 0);
                    ...
                    if (((chk == 2) || (chk == 3) || (chk == 6) || (chk == 7)) && gst == false)  // GST
                    {
                        ...
                        objLedgerBalance.IsTax = true;
                        objLedgerBalance.BillAmount = 0;
                        objLedgerBalance.ReceiptAmount = Math.Round(decimal.Parse(txtGST.Text.Trim()), 0);

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CountryManagement.aspx.cs" Inherits="ExpressDigital.CountryManagement" %>
            ...
            <script type="text/javascript">
                ...
                function RemoveRecord(val) {
                    ...
                    bootbox.confirm("Are you sure to delete ?", function (result) {
                        var link = "CountryManagement.aspx";
                        if (result) {

                            $.ajax({
                                type: "POST",
                                url: "CountryManagement.aspx/OnSubmit",
                    ...
                    <div class="form-group">
                        <div class="div-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="txtCountry" ForeColor="Red" Display="Dynamic"

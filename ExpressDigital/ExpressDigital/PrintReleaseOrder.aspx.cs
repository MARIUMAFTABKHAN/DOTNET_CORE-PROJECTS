...
{
    public partial class PrintReleaseOrder : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var ov = db.usp_AllInvoicesBilling2(companyid, cityid, masteragencyid, AgencyId, ClinetId, invoiceid,StartDate ,EnDate,"").ToList();
                ...
                {
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports") + "/PrintReleaseOrder.rdlc";
                    //  ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports") + "/PrintALLCRVDetails.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports") + "/PrintExp_ReleaseOrder.rdlc";

                }               
                rp[0] = new ReportParameter("pmCompany",  myWords);
                rp[1] = new ReportParameter("pmInvoiceNo", txtSearchROMODateTo.Text);

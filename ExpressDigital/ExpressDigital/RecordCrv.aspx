<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RecordCrv.aspx.cs" Inherits="ExpressDigital.RecordCrv" %>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:CheckBoxList ID="ddlClient" CssClass="CheckboxList" AutoPostBack="false" runat="server">
                                                    </asp:CheckBoxList>
                                                </div>
                                                <div class="col-md-1">

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RoleManagement.aspx.cs" Inherits="ExpressDigital.RoleManagement" %>
            ...
            <script type="text/javascript">
                ...
                function RemoveRecord(val) {
                    bootbox.confirm("Are you sure to delete ?", function (result) {
                        var link = "RoleManagement.aspx";
                        if (result) {
                            $.ajax({
                                type: "POST",
                                url: "RoleManagement.aspx/OnSubmit",
                    ...
                    <div class="form-group">
                        <div class="div-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="txtRoleName" ForeColor="Red" Display="Dynamic" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>

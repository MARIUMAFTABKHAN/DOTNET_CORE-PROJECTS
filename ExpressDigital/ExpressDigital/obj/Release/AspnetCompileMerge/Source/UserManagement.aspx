<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UserManagement.aspx.cs" Inherits="ExpressDigital.UserManagement" %>
            ...
            <script type="text/javascript">
                ...
                function RemoveRecord(val) {
                    bootbox.confirm("Are you sure to delete ?", function (result) {
                        var link = "UserManagement.aspx";
                        if (result) {
                            $.ajax({
                                type: "POST",
                                url: "UserManagement.aspx/OnSubmit",
                    ...
                    <div class="form-group">
                        <div class="div-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="txtUserID" ForeColor="Red" Display="Dynamic"
                                        ...
                                        <ItemTemplate>
                                            <center>
                                                <asp:ImageButton runat="server" ID="DelButton" ImageUrl='~/Content/images/Trash-Cancel.ico'
                                                    ValidationGroup="a" OnClick="DelButton_Click" OnClientClick='<%# "RemoveRecord(" +Eval("ID") + " );" %>' />
                                            </center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>

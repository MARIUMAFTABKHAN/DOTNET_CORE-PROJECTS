<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="DesignationManagement.aspx.cs" Inherits="ExpressDigital.DesignationManagement " %>
                    ...
                    <div class="form-group">
                        <div class="div-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator ControlToValidate="txtDesignation" ForeColor="Red" Display="Dynamic" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="div-md-12" style="margin-top: 50px;">
                            <asp:GridView ID="gv" PageSize="25" runat="server" CssClass="EU_DataTable" DataKeyNames="ID" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="DesignationName" HeaderText="Portal">

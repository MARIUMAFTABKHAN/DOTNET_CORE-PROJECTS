<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MediaBuyingHouses.aspx.cs" Inherits="EPOMS.MediaBuyingHouses" %>
         ...
         <script type="text/javascript">
             function RemoveRecord(val) {
                 bootbox.confirm("Are you sure to delete ?", function (result) {
                     var link = "MediaBuyingHouses.aspx";
                     if (result) {
                         $.ajax({
                             type: "POST",
                             url: "MediaBuyingHouses.aspx/OnSubmit",
            ...
            <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <asp:TextBox ID="txtadd1" runat="server" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ControlToValidate="txtadd1" ForeColor="Red" Display="Dynamic"
                        ...
                        <div class="col-md-3">
                             ...
                             <asp:RequiredFieldValidator ControlToValidate="txtadd2" ForeColor="Red" Display="Dynamic"
                ...
                <div class="form-group">
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <asp:TextBox ID="txtadd3" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ControlToValidate="txtadd3" ForeColor="Red" Display="Dynamic"
                        ...
                        <div class="col-md-3">
                             <asp:TextBox ID="txtadd4" runat="server" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ControlToValidate="txtadd4" ForeColor="Red" Display="Dynamic"
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <asp:TextBox ID="txttel" runat="server" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ControlToValidate="txttel" ForeColor="Red" Display="Dynamic"
                        ...
                        <div class="col-md-3">
                             ...
                             <asp:RequiredFieldValidator ControlToValidate="txtfax" ForeColor="Red" Display="Dynamic"
                    ...
                    <div class="div-md-12" style="margin-top: 50px;">
                        <asp:GridView ID="gv" PageSize="25" runat="server" CssClass="EU_DataTable" DataKeyNames="ID" AutoGenerateColumns="false"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MediaHouse" HeaderText="Media House"><HeaderStyle Width="25%" /></asp:BoundField>
                                <asp:BoundField DataField="EmailAddress" HeaderText="Email Address"><HeaderStyle Width="25%" /></asp:BoundField>
